...
*/        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                 _imageService.Delete($"/Images/users/{user.Id}.jpg");

               var (IsUploaded, errorMessage) =await _imageService.UploadAsync(Input.Avatar,$"{user.Id}.jpg","/Images/users/",IsThumbnail:false);

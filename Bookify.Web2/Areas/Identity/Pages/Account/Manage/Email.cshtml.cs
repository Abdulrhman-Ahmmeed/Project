...
namespace Bookify.Web2.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public EmailModel(
            ...
            IEmailSender emailSender,IEmailBodyBuilder emailBody)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                var placeHolder = new Dictionary<string, string>()
                {
                    ...
                    {"body", "Please click the below button to change your Email"},
            ...
            var placeHolder = new Dictionary<string, string>()
                {
                    {"imageUrl", "https://res.cloudinary.com/devcreed/image/upload/v1668732314/icon-positive-vote-1_rdexez.svg" },
                    {"header",$"Hey {user.FullName}, thank for joining us!" },
                    {"body","Please confirm your account by clicking the button" },
                    {"url",$"{HtmlEncoder.Default.Encode(callbackUrl!)}" },
                    {"linkTitle","Change Email" }

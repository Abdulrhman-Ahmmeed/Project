...
namespace Bookify.Web2.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        public ResendEmailConfirmationModel(UserManager<ApplicationUser> userManager, IEmailSender emailSender, IEmailBodyBuilder bodyBuilder)
        {
...
*/            public string username { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var user = await _userManager.Users
               ...
               (u => (u.NormalizedUserName == Input.username.ToUpper() || u.NormalizedEmail == Input.username.ToUpper()) && !u.IsDeleted);
